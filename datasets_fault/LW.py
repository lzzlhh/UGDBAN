...
dataname= {0:[os.path.join('LW-00',work_condition[0]),
              os.path.join('LW-01',work_condition[0]),
              os.path.join('LW-02',work_condition[0]),
              os.path.join('LW-03',work_condition[0]),
              ],
         1:[os.path.join('LW-00',work_condition[1]),
              os.path.join('LW-01',work_condition[1]),
              os.path.join('LW-02',work_condition[1]),
              os.path.join('LW-03',work_condition[1]),
              ],
           2: [os.path.join('LW-00', work_condition[2]),
               os.path.join('LW-01', work_condition[2]),
               os.path.join('LW-02', work_condition[2]),
               os.path.join('LW-03', work_condition[2]),
               ],
           3: [os.path.join('LW-00', work_condition[3]),
               os.path.join('LW-01', work_condition[3]),
               os.path.join('LW-02', work_condition[3]),
               os.path.join('LW-03', work_condition[3]),
               ],
           4: [os.path.join('LW-00', work_condition[4]),
               os.path.join('LW-01', work_condition[4]),
               os.path.join('LW-02', work_condition[4]),
               os.path.join('LW-03', work_condition[4]),
               ],
           }
...
def data_load(filename, label):
    ...
    start, end = 0, signal_size
    sample_count = 0
    while end <= fl.shape[0] and sample_count < 300:
