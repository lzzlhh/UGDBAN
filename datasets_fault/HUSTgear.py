...
work_condition=['_0.txt','_0.txt','_0.txt','_0.txt']
dataname= {0:[os.path.join('C_L1_VS_0_40'+work_condition[0]),
              os.path.join('H_L1_VS_0_40'+work_condition[0]),
              os.path.join('M_L1_VS_0_40'+work_condition[0]),
              ],
         1:[os.path.join('C_L2_VS_0_40'+work_condition[1]),
              os.path.join('H_L2_VS_0_40'+work_condition[1]),
              os.path.join('M_L2_VS_0_40'+work_condition[1]),
           ],
        2: [os.path.join('C_L3_VS_0_40' + work_condition[2]),
               os.path.join('H_L3_VS_0_40' + work_condition[2]),
               os.path.join('M_L3_VS_0_40' + work_condition[2]),
               ],
           3: [os.path.join('C_35' + work_condition[3]),
               os.path.join('M_35' + work_condition[3]),
               os.path.join('H_35' + work_condition[3]),
...
def data_load(filename, label):
    ...
    # else:
    df = pd.read_csv(filename)[13:]   # 第13行开始为加速度数据
    df.columns = ['Column']
    ...
    start, end = 0, signal_size
    sample_count = 0
    while end <= fl.shape[0] and sample_count < 500:
