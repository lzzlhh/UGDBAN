...
def Laplace_ResNet18(pretrained=False, **kwargs):
...
class Laplace_ResNet18_features(nn.Module):
    def __init__(self, pretrained=False):
        super(Laplace_ResNet18_features, self).__init__()
        self.Laplace_ResNet18 = Laplace_ResNet18(pretrained)
        self.dim = 256

    def forward(self, x):
        x = self.Laplace_ResNet18(x)
        return x
